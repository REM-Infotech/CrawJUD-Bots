...
//         printf("Erro ao abrir o arquivo de certificado.");
//         return false;
//     }
...
//         printf("Erro ao ler o arquivo de certificado.");
//         delete[] certBuffer;
//         CloseHandle(hFile);
//         return false;
//     }
...
//     if (!pCertContext) {
//         printf("Erro ao criar contexto do certificado.");
//         return false;
//     }

//     // // Abra o armazenamento de certificados pessoal do usuário
//     // HCERTSTORE hCertStore = CertOpenStore(CERT_STORE_PROV_SYSTEM, X509_ASN_ENCODING, NULL, CERT_SYSTEM_STORE_CURRENT_USER, L"MY");
//     // if (!hCertStore) {
...
//     m.doc() = "Módulo para instalar certificados.";
